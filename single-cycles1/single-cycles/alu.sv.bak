module alu(
    ...
    always @(*) begin
        case (alu_control)
            ...
            4'b0111: alu_result = $signed(operand1) >>> operand2[4:0];         // SRA
            4'b1000: alu_result = ($signed(operand1) < $signed(operand2)) ? 32'b1 : 32'b0; // SLT
            4'b1001: alu_result = (operand1 < operand2) ? 32'b1 : 32'b0;      // SLTU
